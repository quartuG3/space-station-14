...
{
    public sealed class MeteorSwarmSmallRule : StationEventSystem<MeteorSwarmSmallRuleComponent>
    {
        [Dependency] private readonly SharedPhysicsSystem _physics = default!;

        protected override void Started(EntityUid uid, MeteorSwarmSmallRuleComponent component, GameRuleComponent gameRule, GameRuleStartedEvent args)
        {
        ...
        protected override void ActiveTick(EntityUid uid, MeteorSwarmSmallRuleComponent component, GameRuleComponent gameRule, float frameTime)
        {
            ...
            for (var i = 0; i < component.MeteorsPerWave; i++)
            {
                ...
                var meteor = Spawn("MeteorSmall", spawnPosition);
