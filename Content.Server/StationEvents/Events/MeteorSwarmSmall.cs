...
{
    public sealed class MeteorSwarmSmall : StationEventSystem
    {
        [Dependency] private readonly SharedPhysicsSystem _physics = default!;

        public override string Prototype => "MeteorSwarmSmall";
        ...
        public override void Update(float frameTime)
        {
            ...
            for (var i = 0; i < MeteorsPerWave; i++)
            {
                ...
                var meteor = EntityManager.SpawnEntity("MeteorSmall", spawnPosition);
