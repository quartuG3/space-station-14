...
ent-MaterialDragonSinew = dragon sinew
    .suffix = Full
    .desc = You feel the ichor pulsing within him.
ent-MaterialDragonSinew1 = { ent-MaterialDragonSinew }
    .suffix = Single
    .desc = { ent-MaterialDragonSinew.desc }
ent-MaterialXenoScale = xeno scale
    .suffix = Full
    .desc = You wouldn't want toxic blood on your skin.
