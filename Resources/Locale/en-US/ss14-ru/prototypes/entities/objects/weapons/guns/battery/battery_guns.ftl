...
ent-WeaponCutter = plasma cutter
    .desc = A miners' tool designed for clearing rocks.
ent-WeaponCutterAdv = advanced plasma cutter
    .desc = A miners' tool designed for clearing rocks. Features an improved battery and a reinforced concentrating lens.
