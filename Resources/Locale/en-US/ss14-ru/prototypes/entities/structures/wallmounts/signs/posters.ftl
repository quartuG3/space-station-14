...
ent-PosterContrabandRevolt = Revolt
    ...
    .suffix = { "" }
ent-PosterContrabandSOPIsShit = SOP Is Shit
    .desc = A poster encouraging people crew to stop using 'standard operating procedures' because they are inefficient and boring.
    .suffix = { "" }
