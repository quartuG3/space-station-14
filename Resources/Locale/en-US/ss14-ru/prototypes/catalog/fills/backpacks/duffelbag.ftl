...
ent-ClothingBackpackDuffelSyndicateAmmoPistolFilled = bundle with pistol magazines (.35)
    .desc = A bundle of extended pistol magazines. 2 standard and 2 HV. Adaptation for Viper.
ent-ClothingBackpackDuffelSyndicateAmmoPistolSubMachineGunBundle = bundle with SMG magazines (.35)
    .desc = A bundle containing magazines for SMG. 2 standard and 2 HV. Compatible with C-20r.
ent-ClothingBackpackDuffelSyndicateAmmoShotGunBundle = bundle with shotgun magazines (.50)
    .desc = A bundle containing magazines for a shotgun. 2 standard, 2 bullet and 1 incendiary. Compatible with Bulldog.
ent-ClothingBackpackDuffelSyndicateAmmoCaselessRifleBundle = bundle with rifle magazines (.25)
    .desc = A bundle containing magazines for a rifle. 2 standard and 2 HV. Compatible with KR51.
