...
signal-port-description-autoclose = Переключает автоматическое закрытие устройства.
...
signal-port-description-doorbolt = Переключает дверные болты при получении ВЕРХНЕГО параметра.
...
signal-port-name-set-particle-delta = Установить тип частиц: дельта
signal-port-description-set-particle-delta = Устанавливает тип частиц, испускаемых этим устройством, на дельта.
signal-port-name-set-particle-epsilon = Установить тип частиц: эпсилон
signal-port-description-set-particle-epsilon = Устанавливает тип частиц, испускаемых этим устройством, на эпсилон.
signal-port-name-set-particle-zeta = Установить тип частиц: зетта
signal-port-description-set-particle-zeta = Устанавливает тип частиц, испускаемых этим устройством, на зетта.
signal-port-name-set-particle-sigma = Установить тип частиц: сигма
signal-port-description-set-particle-sigma = Устанавливает тип частиц, испускаемых этим устройством, на сигма.
signal-port-name-logic-input-a = Вход А
signal-port-description-logic-input-a = Первичный вход логического элемента.
