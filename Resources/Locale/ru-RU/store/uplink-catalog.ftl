...
uplink-reinforcement-radio-cyborg-assault-desc = Проворная машина для убийств, имеющая в арсенале энергетический меч, L6 ROW, криптографический секвенсор и поисковой навигатор.
...
uplink-syndicate-weapon-module-desc = Этот модуль даст киборгу продвинутый лазер и мачете.
uplink-singularity-beacon-name = Маяк сингулярности
uplink-singularity-beacon-desc = Устройство, притягивающее сингулярности. Должно быть закреплено и запитано. При поглощении вызывает рост сингулярностей.
# Импланты
...
uplink-scram-implanter-name = Имплантёр Удрать
...
uplink-mobcat-microbomb-name = СиндиКошка
uplink-mobcat-microbomb-desc = Ручная кошка, оснащённая имплантом микробомбы. Взрывается при получении серьезных ранений. Может больно укусить.
# Безделушки
