...
uplink-cluster-grenade-desc = Три разрывные гранаты, соединённые вместе. Кластер делится через 3.5 секунды.
...
uplink-stealth-box-desc = Ящик, оснащённый технологией невидимости. Пробирайтесь незаметно, но не двигайтесь слишком быстро, иначе вас раскроют!
...
uplink-syndicate-weapon-module-desc = Оснащает киборга продвинутым лазерным пистолетом и мачете.
...
uplink-power-sink-desc = Вытягивает огромное количество электроэнергии из сети, затем взрывается, когда полностью заряжен. Подключите его к проводам с помощью гаечного ключа.
...
uplink-clothing-thieving-gloves-desc = Незаметно обчищайте карманы и повышайте свой навык воровства с помощью этих новых модных перчаток. Они даже выглядят как обычные!
...
uplink-nocturine-chemistry-bottle-desc = Химическое вещество, которое погружает вашу цель в сон.
