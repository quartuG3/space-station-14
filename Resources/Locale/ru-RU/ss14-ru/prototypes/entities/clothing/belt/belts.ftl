...
ent-ClothingBeltMedSec = медико-охранный пояс
    .desc = Пояс, исппользуемый для хранения охранной и медицинской экипировки.
...
ent-ClothingBeltSalvageWebbing = РПС утилизаторов
    .desc = Универсальная система разгрузки для работы в пространстве.
ent-ClothingBeltMinerWebbing = РПС шахтеров
    .desc = Универсальная система разгрузки для работы в пространстве.
