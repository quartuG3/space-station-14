...
ent-ClothingShoesBootsWinterSci = научные зимние сапоги
    .desc = { ent-ClothingShoesBaseWinterBoots.desc }
ent-ClothingShoesBootsWinterSec = охранные зимние сапоги
    .desc = { ent-ClothingShoesBaseWinterBoots.desc }
...
ent-ClothingShoesBootsWinterWeb = паутинные зимние сапоги
    .desc = Сапоги, изготовленные из плотной паутины, помогут пережить даже самую холодную зиму.
ent-ClothingShoesBootsCowboyBrown = коричневые ковбойские сапоги
    .desc = У них есть звенящие шпоры.
