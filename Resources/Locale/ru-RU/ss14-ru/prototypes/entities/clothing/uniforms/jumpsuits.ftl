...
ent-ClothingUniformJumpsuitERTSecurity = униформа службы безопасности ОБР
    ...
    .suffix = { "" }
ent-ClothingUniformJumpsuitCBURNAgent = униформа агента РХБЗЗ
    .desc = Специальный костюм, созданный для агентов отряда РХБЗЗ ЦентКома.
    .suffix = { "" }
ent-ClothingUniformJumpsuitDeathSquadOfficer = униформа офицера эскадрона смерти
    .desc = Специальный костюм, созданный для офицеров эскадрона смерти ЦентКома.
    .suffix = { "" }
