...
ent-ClothingEyesHudMedSec = медико-охранный визор
    .desc = Объединяет в себе функционал медицинского и охранного визоров для большей эффективности.
...
ent-ClothingEyesEyepatchHudMedical = глазная повязка с медицинским визором
    .desc = Повязка с линзой, оснащённой индикатором на стекле, который сканирует гуманоидов в поле зрения и предоставляет точные данные о состоянии их здоровья. Для настоящих патриотов.
ent-ClothingEyesEyepatchHudSecurity = глазная повязка с охранным визором
    .desc = Повязка с линзой, оснащённой индикатором на стекле, который сканирует гуманоидов в поле зрения и предоставляет точные данные об их идентификационном статусе и записях в системе безопасности. Для настоящих патриотов.
ent-ClothingEyesEyepatchHudBeer = пивная глазная повязка
    .desc = Повязка с линзой, оснащенной сканером реагентов, а также дающая понимание вязкости жидкости во время движения. Для настоящих патриотов.
