ent-ClothingNeckCloakCentcom = плащ центрального командира
    .desc = Напыщенный и элитный зелёный плащ с красивой золотой отделкой, сшитый специально для Центрального Командира. Он такой тяжёлый, что золотая отделка может быть настоящей.
