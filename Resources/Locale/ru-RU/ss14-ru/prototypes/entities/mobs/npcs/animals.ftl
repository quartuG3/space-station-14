...
ent-MobBaseAncestor = генетический предок
    .desc = Генетический двуногий предок... э-э... чего-то. Да, на станции определенно есть что-то, произошедшее от того, что это такое.
...
ent-MobKobold = кобольд
    .desc = Двоюродные братья разумной расы унатхов, кобольды сливаются со своей естественной средой обитания, но при этом они такие же вредные, как обезьяны, готовые вырвать у вас волосы и заколоть до смерти.
