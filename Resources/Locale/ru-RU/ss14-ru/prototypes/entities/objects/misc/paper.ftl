...
ent-BoxFolderQmClipboard = цифро-борд заказов
    .desc = Громоздкий цифровой клипборд, заполненный заказами на поставку и финансовыми данными. При таком количестве компрометирующих документов его следует беречь.
