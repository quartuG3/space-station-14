...
ent-FloorTileItemSteelCheckerDark = тёмная стальная клетчатая плитка
...
ent-FloorTileItemJungleAstroGrass = астро-трава
    .desc = { ent-FloorTileItemAstroGrass.desc }
...
ent-FloorTileItemAstroSnow = астро-снег
    .desc = Искусственный снег, такой же пушистый, как настоящий, при этом легко убирается!
