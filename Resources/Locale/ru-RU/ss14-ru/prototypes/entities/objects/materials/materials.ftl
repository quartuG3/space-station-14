...
ent-MaterialDragonSinew = драконьи жилы
    .suffix = Полный
    .desc = Вы чувствуте пульсирующий внутри ихор.
ent-MaterialDragonSinew1 = { ent-MaterialDragonSinew }
    .suffix = Один
    .desc = { ent-MaterialDragonSinew.desc }
ent-MaterialXenoScale = чешуя пришельца 
    .suffix = Полный
    .desc = Вы бы не хотели, чтобы токсичная кровь оказалась на вашей коже
ent-MaterialXenoScale1 = { ent-MaterialXenoScale }
    .suffix = Один
    .desc = { ent-MaterialXenoScale.desc }
