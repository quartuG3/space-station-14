ent-MineralScannerUnpowered = сканер минералов
    .desc = Сканер, который проверяет окружающую породу на наличие полезных минералов. Для работы он должен находиться в руке или кармане.
...
ent-AdvancedMineralScannerUnpowered = продвинутый сканер минералов
    .desc = Сканер, который проверяет окружающую породу на наличие полезных минералов. Для работы он должен находиться в руке или кармане. У этого сканера увеличенный радиус действия.
    .suffix = Не требует питания
