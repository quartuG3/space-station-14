...
ent-BoxDeathRattleImplants = коробка имплантов предсмертнохрип
    .desc = Шесть имплантов предсмертнохрип и глобальных систем позиционирования для всего отряда.
...
ent-BoxArtifactMiners = коробка шахтёрского артефакта
    .desc = Содержит в себе артефакты добытые шахтёрами.
