...
ent-CrateEngineeringSingularityCollector = ящик с коллектором радиации
    .desc = Коллектор для радиации, использующийся в сингулярном двигателе. Баллон плазмы прилагается.
...
ent-CrateEngineeringSolar = ящик сборных солнечных панелей
    .desc = Набор с плоскоблоками солнечных панелей и стеклом для создания десяти солнечных панелей.
