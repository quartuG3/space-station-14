...
ent-ClothingBackpackERTJanitorFilled = { ent-ClothingBackpackERTJanitor }
    ...
    .suffix = { "" }
ent-ClothingBackpackCBURNAgentFilled = рюкзак агента РХБЗЗ
    .desc = Вместительный рюкзак с множеством карманов, который носят агенты отряда РХБЗЗ
    .suffix = { "" }
ent-ClothingBackpackDeathSquadOfficerFilled = рюкзак офицера эскадрона смерти
    .desc = Вместительный рюкзак с множеством карманов, который носят офицеры эскадрона смерти
    .suffix = { "" }
