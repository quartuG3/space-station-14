...
forensic-scanner-report-title = Отчёт криминал-сканера: { $entity }
...
forensics-verb-message = Удалите отпечатки пальцев и остатки ДНК с объекта!
forensics-cleaning = Вы начинаете стирать следы с { $target }...
forensics-cleaning-cannot-clean = На { $target } нет ничего, что можно было бы очистить!
