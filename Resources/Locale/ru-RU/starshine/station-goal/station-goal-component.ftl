station-goal-fax-paper-name = Цель станции { $station }
station-goal-start =
    ⠀┌────────────────────────┐
    ⠀│[color=#228B22]██╗███╗░░██╗████████╗░░░ [/color]│[head=3]   Автоматическое[/head]
    ⠀│[color=#228B22]╚█║████╗░██║╚══██╔══╝░░░ [/color]│[head=3]      сообщение[/head]
    ⠀│[color=#228B22]░╚╝██╔██╗██║░░░██║░░░░░░ [/color]│[head=2]      NanoTrasen[/head]
    ⠀│[color=#228B22]░░░██║╚████║░░░██║░░░█╗░ [/color]│[bold] Центральное командование[/bold]
    ⠀│[color=#228B22]░░░██║░╚███║░░░██║░░░██╗ [/color]│[bold][head=3]         ЦК-{ $station }[/head][/bold]
    ⠀│[color=#228B22]░░░╚═╝░░╚══╝░░░╚═╝░░░╚═╝ [/color]│
    ⠀└────────────────────────┘
    ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
