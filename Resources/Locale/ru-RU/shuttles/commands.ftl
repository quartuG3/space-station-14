...
cmd-ftldisk-map-paused = Объект { $определение } находится на карте { $map }, которая на паузе! Пожалуйста, сначала снимите паузу с карты, иначе игроки застрянут на месте.
